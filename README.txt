...
[GM 팀 점수판]
- GM 화면에서 5개 팀의 팀명을 직접 수정할 수 있습니다.
- 각 팀 점수는 -1 / +1 버튼 또는 숫자 직접 입력으로 수정할 수 있습니다.
- 다른 GM 화면에도 실시간 동기화됩니다.
- 점수 초기화 버튼으로 모든 팀 점수를 0점으로 만들 수 있습니다.
- 무료 Render 서버 자체가 재시작되면 팀명/점수는 기본값으로 초기화됩니다. (문제 데이터와는 별개)

[제목 줄바꿈]
Admin의 테마 제목 칸에서 Enter를 누르면 정답 화면에서도 같은 위치에서 줄바꿈됩니다.
